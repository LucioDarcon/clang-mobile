...
URL: http://llvm..org/
Source: http://llvm.org/releases/5.0.0git-11eb3440/Obfuscator-LLVM-5.0.0git-11eb3440.tar.gz
...
%prep
%setup -q -n Obfuscator-LLVM-5.0.0git-11eb3440
